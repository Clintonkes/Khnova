    ...
    <header className="sticky top-0 z-50 bg-knova-mist/95 backdrop-blur border-b border-knova-ink/10">
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <div className="flex items-center justify-between h-[72px]">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/quote" className="px-5 py-2.5 rounded-full bg-knova-cyan text-knova-midnight font-dmsans text-sm font-bold hover:bg-knova-midnight hover:text-knova-cyan transition">Free Quote</Link>
          </div>
      ...
      {open && (
        <div className="md:hidden bg-knova-mist border-t border-knova-ink/10 px-5 py-4 space-y-1">
          ...
          <Link to="/quote" onClick={() => setOpen(false)} className="block text-center px-4 py-3 rounded-full bg-knova-cyan text-knova-midnight font-dmsans font-bold">Get a Free Quote</Link>
        </div>
      )}
    </header>
  );
